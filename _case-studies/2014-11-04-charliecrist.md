...
With day to day organizing efforts from the panhandle to the Keys, every campaign action represented an opportunity to tell our story. Drawing on my background as both an organizer and visual communicator, I trained more than 100 field staff in digital and social media best practices, including how to capture and share compelling photography in the field. With an emphasis on authentic, people-centered storytelling, I organized a network of digital leads across regions to coordinate content gathering and coach colleagues and volunteers, establishing a system that encouraged visual material to flow from local events into the campaign’s broader online engagement effort.
  ...
  <div class="cs-image-block cs-two-by-two-sm-up">
    <div class="image-radius-small">
        <img src="/assets/editing/20140719-CharlieCrist-tweet-01.jpg" alt="A tweet by Stephen Cummings in 2014, sharing the motivation behind one volunteer's support for Charlie Crist for Governor" />
    </div>
    <div class="image-radius-small">
        <img src="/assets/editing/20140910-CharlieCrist-tweet-02.jpg" alt="A tweet by Charlie Crist in 2014, sharing a photo from Kissimmee showing the crowd of volunteers gathered to welcome the governor's visit to their local office" />
    </div>
  </div>
